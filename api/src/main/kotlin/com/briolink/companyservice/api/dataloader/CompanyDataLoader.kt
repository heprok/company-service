...
//                     isTypePublic = true,
//                     createdBy = UUID.randomUUID(),
//                     description = "Walmart is a retailing company that operates a chain of hypermarkets, discount department stores, and grocery stores.", // ktlint-disable max-line-length
//                 ).apply {
...
//                     isTypePublic = true,
//                     createdBy = UUID.randomUUID(),
//                     description = "Tata Group is an international conglomerate that owns and operates independent companies, with the main focus on steel, hydro-power, hospitality, and airline industries. ", // ktlint-disable max-line-length
//                 ).apply {
